...
public class MyAdapter2 extends BaseAdapter {
    ...
    public MyAdapter2(Context context, List<MyBean.ResultBean.PzshBean.CommodityListBeanX> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MyBean.ResultBean.PzshBean.CommodityListBeanX xx = list.get(position);
